...
<body <?php body_class('bg-surface text-on-surface font-body selection:bg-primary/20'); ?>>
    ...
    <nav class="fixed top-0 w-full z-50 bg-[#fff8f5]/80 backdrop-blur-md flex justify-between items-center px-8 py-4 max-w-full glass-nav border-b border-black/5">
