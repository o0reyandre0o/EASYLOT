...
<section class="py-24 px-8 md:px-20 bg-surface">
    <div class="max-w-7xl mx-auto">
        ...
        <div class="space-y-12">
            ...
            <div class="bg-surface-container-low rounded-3xl overflow-hidden flex flex-col lg:flex-row shadow-sm border border-black/5 hover:border-primary/20 transition-colors group">
                <div class="relative overflow-hidden lg:w-1/2 lg:flex-shrink-0 min-h-[400px] bg-center bg-cover"
                     style="background-image: url('https://easylot.ky/wp-content/uploads/2023/08/elena-estates-little-cayman-sitemap-satellite.jpg');">
                    <img src="https://easylot.ky/wp-content/uploads/2023/08/elena-estates-little-cayman-sitemap-satellite.jpg" alt="Investment property for sale at Elena Estates, Little Cayman" loading="lazy" class="sr-only" />
                ...
                <div class="p-12 flex flex-col justify-center lg:w-1/2">
            ...
            <div class="bg-surface-container-low rounded-3xl overflow-hidden flex flex-col lg:flex-row shadow-sm border border-black/5 hover:border-primary/20 transition-colors group">
                <div class="relative overflow-hidden lg:w-1/2 lg:flex-shrink-0 min-h-[400px] bg-center bg-cover lg:order-2"
                     style="background-image: url('https://easylot.ky/wp-content/uploads/2024/07/rum-point-cayman-islands-1.jpg');">
                    <img src="https://easylot.ky/wp-content/uploads/2024/07/rum-point-cayman-islands-1.jpg" alt="Aerial view of land for sale at Northshore Estates, Grand Cayman" loading="lazy" class="sr-only" />
                ...
                <div class="p-12 flex flex-col justify-center lg:w-1/2 lg:order-1">
            ...
            <div class="bg-surface-container-low rounded-3xl overflow-hidden flex flex-col lg:flex-row shadow-sm border border-black/5 hover:border-primary/20 transition-colors group">
                <div class="relative overflow-hidden lg:w-1/2 lg:flex-shrink-0 min-h-[400px] bg-center bg-cover"
                     style="background-image: url('https://easylot.ky/wp-content/uploads/2023/08/High-Rock-Estates.jpg');">
                    <img src="https://easylot.ky/wp-content/uploads/2023/08/High-Rock-Estates.jpg" alt="Investment property for sale at High Rock Estates, Grand Cayman" loading="lazy" class="sr-only" />
